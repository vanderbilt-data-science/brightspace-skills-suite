...
| **`brightspace-module-publish`** | Publish a prepared package as a content module | `bs_session.py`, `publish.py` |
...
for s in brightspace-course brightspace-manage brightspace-grading \
         course-video-prep brightspace-module-publish; do
...
brightspace-module-publish/    Publish a prepared package as a content module
